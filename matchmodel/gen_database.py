...
caffe.set_mode_gpu()
image_num = 1600
img_file = '/mnt/sda/backup/data/test/%d.jpg'
...
weights = '/mnt/sda/backup/match/model_iter_40000.caffemodel'
db_filename = '/mnt/sda/backup/match/testvector_finetune.json'
#db_filename = '/mnt/sda/backup/match/database_finetune.json'
